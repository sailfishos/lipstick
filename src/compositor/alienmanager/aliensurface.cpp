...
const struct wl_interface *AlienSurface::interface()
{
    return &alien_surface_interface;
}

QByteArray AlienSurface::interfaceName()
{
    return QByteArrayLiteral("alien_surface");
}
