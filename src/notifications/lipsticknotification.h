...
public:
    ...
    //! Nemo hint: Action input specification for remote action. Prefix only: the action identifier is to be appended.
    static const char *HINT_REMOTE_ACTION_INPUT_PREFIX;
